...
router.delete('/:id', authenticateToken, authorizeRoles('admin', 'editor'), tagApi.deleteTag);

// 管理路由（需要管理员权限）
router.get('/admin/stats', authenticateToken, authorizeRoles('admin'), tagApi.getTagStats);
